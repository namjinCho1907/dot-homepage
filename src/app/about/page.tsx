        ...
        <nav className="container mx-auto px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <a href="/" className="text-2xl font-medium text-white tracking-tight hover:text-gray-300 transition-colors">Dot.</a>
            </div>
            <div className="hidden md:flex items-center space-x-10">
              <a href="/" className="text-gray-300 hover:text-white transition-all duration-300 font-medium tracking-tight">홈</a>
